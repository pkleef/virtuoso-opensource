...
Download prebuilt binaries for most Linux, macOS and Windows platforms from [the latest stable release on GitHub](https://github.com/openlink/virtuoso-opensource/releases/latest).

Previous releases are also backed-up on [Sourceforge](https://sourceforge.net/projects/virtuoso/files/virtuoso/).

### Using Docker Hub

To get started with the Virtuoso Docker image, visit [README.Docker.md](https://hub.docker.com/repository/docker/openlink/virtuoso-opensource-7/general).

For deeper discussion and instructions on building your own, see the [community forum](https://community.openlinksw.com/t/building-a-virtuoso-open-source-edition-reference-docker-image/4219).
...
The build produces a demo database and Virtuoso application packages that are quite large. At least 1.2 GiB of free space should be available in the build file system.

When running `make install`, the target file system should have about 300 MB free. By default, the install target directories are under /usr/local/.
